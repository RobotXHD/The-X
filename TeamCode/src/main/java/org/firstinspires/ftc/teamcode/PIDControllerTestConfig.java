...
public class PIDControllerTestConfig {
    ...
    public static double sidewaysCalib = 45.8636, rotationCalib = 76;
    public static double toleranceX = 200, toleranceY = 200, toleranceRotatie = 2;
    public static int targetVerifications = 12;
}
